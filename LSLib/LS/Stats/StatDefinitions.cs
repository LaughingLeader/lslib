...
public class StatDefinitionRepository
{
    ...
    private static void MergeDict<T>(IDictionary<string, T> a, IDictionary<string, T> b)
    {
        if(b != null)
        {
    ...
    public StatDefinitionRepository(StatDefinitionRepository other)
    {
        if(other != null)
        {
            MergeDict(Enumerations, other.Enumerations);
            MergeDict(Types, other.Types);
            MergeDict(Functors, other.Functors);
            MergeDict(Boosts, other.Boosts);
            MergeDict(DescriptionParams, other.DescriptionParams);
        }
    }
